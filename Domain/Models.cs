...
namespace ShiftSync.Domain
{
    ...
    public sealed class UserPrefrences
    {
        public bool KeeepEveningsFree { get; init; }
        public bool KeeepMorningsFree { get; init; }

        //optional prefrence 
        public System.Collections.Generic.List<AvailabilityWindow> PreferredWindow { get; init; } = new();
    }
    ...
    {
        public System.Collections.Generic.List<TimeBlock> Blocks { get; init; } = new();
